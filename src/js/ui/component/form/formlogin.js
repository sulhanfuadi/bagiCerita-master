    ...
    return html`
      ...
      <form class="form-input-form" novalidate>
        ...
        <input-component
          ...
          name="${msg(`Password`)}"
          type="password"
          placeholder="${msg(`bismillahGacor`)}"
          idscss="password-input"
          invalidFeedbackMessage="${msg(`Please complete this field`)}"
          required
        ></input-component>
        <show-password
          class="input-component-root-class-name20"
        ></show-password>
