...
class LocalePicker extends LitWithoutShadowDom {
  ...
  render() {
    return html`
      <button
        id="dropdown-dark"
        class="btn btn-dark btn-sm dropdown-toogle show"
        aria-expanded="true"
      ...
      >
        <div class="dropdown-menu" @click=${this._menuClicked}>
          <!-- add this line to add a click event listener to the dropdown menu -->
        ...
        <!-- add this line to display the selected locale name -->
      </button>
    `;
  }
